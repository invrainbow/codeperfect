...
enum Nvim_Request_Type {
    ...
    NVIM_REQ_POST_INSERT_DOTREPEAT_CREATE_BUF,
    NVIM_REQ_POST_INSERT_DOTREPEAT_OPEN_WIN,
    NVIM_REQ_POST_INSERT_DOTREPEAT_SET_LINES,
    NVIM_REQ_POST_INSERT_DOTREPEAT_SET_CURSOR,
    NVIM_REQ_POST_INSERT_DOTREPEAT_INPUT,
    NVIM_REQ_POST_INSERT_DOTREPEAT_RESTORE_WIN,
    NVIM_REQ_POST_INSERT_DOTREPEAT_CLOSE_NEW_WIN,
